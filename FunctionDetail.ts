...
function myCallingFunction(initText, myCallBack)
{
 ...
 function myCallBackCallingFunctionTs(initText : string, myCallBackTs : (initText : string) => void )
 {
 ...
 */ 
 ...
 function addTs(arg1 : number, arg2 : number) : number;
 function addTs(arg1 : string, arg2 : string) : string;
 function addTs(arg1 : boolean, arg2 : boolean) : boolean;
 function addTs(arg1 : any, arg2 : any) : any
 {
	 return arg1 + arg2;
 } 
 ...
 function fnUnionType(
	                    arg1 : number | string | boolean,
						arg2 : number | string | boolean ) : number | string | boolean
						{
 ...
 type NumberStrigBoolean = number | string | boolean;
 
 function fnUnionTypeByAliases(arg1 : NumberStrigBoolean, arg2 : NumberStrigBoolean ) : NumberStrigBoolean
 {
	 if(typeof(arg1) === "number")
	{
		return arg1 + " : is a number";
 ...
 console.log("fnUnionTypeByAliases arg1 : "  +  fnUnionTypeByAliases(false,true));
  ...
  type fnSignatureAdd = (string) => void;
  function myCallBackType(initText : string)
  {
	  console.log("myCallBackTpe : " + initText);
	 
  } 
  function myCallBackTypeCalling(initText : string, myCallBackType : fnSignatureAdd )
  {
